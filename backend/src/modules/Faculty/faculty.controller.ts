...
import { createFaculty, deleteFaculty, listFaculties,getFacultyById, updateFaculty } from './faculty.service';
...
export const listFacultiesHandler = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const facultyList = await listFaculties(page, limit, filter);
...
export const getFacultyByIdHandler = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const facultyId = veritfyParam(facultyIdParam, 'facultyId');
